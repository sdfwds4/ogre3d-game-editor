...
namespace OgreBites
{
	...
	=============================================================================*/
	class GuiManagerListener
    {
    public:

		virtual ~GuiManagerListener() {}
	...
	public:
		...
		void _assignListener(GuiManagerListener* listener) { mListener = listener; }

	protected:

		Ogre::OverlayElement* mElement;
		TrayLocation mTrayLoc;
		GuiManagerListener* mListener;
	};
	...
	=============================================================================*/
	class GuiManager : public GuiManagerListener
    {
    public:
		...
		GuiManager(const Ogre::String& name, Ogre::RenderWindow* window, GuiManagerListener* listener = 0) :
		...
		void setListener(GuiManagerListener* listener)
		{
			mListener = listener;
		}

		GuiManagerListener* getListener()
		{
			return mListener;
		}
    ...
    protected:
		...
		GuiManagerListener* mListener;           // tray listener
